        ...
        const fetchItemDetails = async () => {
            ...
            if (itemData) {
                ...
                const newItem: Item = {
                    ...
                    category: [itemData.type.charAt(0).toUpperCase() + itemData.type.slice(1)], // 'Donate' or 'Swap'
                    condition: itemData.condition === 'Liked New' ? 'Like New' : itemData.condition,
                    co2Saved: "1.2kg CO₂", // Placeholder logic
                    ...
                    <div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                />
                                <div>
                                    <h4 className="font-regular text-xl text-[#00000099]">{item.owner.name}</h4>
